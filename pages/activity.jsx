  ...
  return (
    ...
    <Head>
        ...
        <div
            ...
            className='w-full bg-cover bg-bottom sm:bg-fixed flex min-h-screen relative justify-self-center self-center space-y-2'
        >
          <div className='flex font-CS font-bold text-2xl md:text-3xl lg:text-4xl items-center object-top justify-center'>
              Activities
          </div>
