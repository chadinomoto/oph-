...
*/
const wcText =
  'งานเปิดบ้านโรงเรียนมหิดลวิทยานุสรณ์ หรือ MWIT Open House เป็นงานที่จะเปิดโอกาสให้ทุกคนมาร่วมรู้จักตัวตนของมหิดลวิทยานุสรณ์ผ่านกิจกรรมต่าง ๆ\n ที่จะทำให้ผู้เข้าร่วมมีความรู้และความเข้าใจเกี่ยวกับโรงเรียนมากขึ้น ซึ่งในปีนี้จะกลับมาจัดในรูปแบบ on-site ทั้งหมด 2 วัน\nคือวันศุกร์ที่ 25 และวันเสาร์ที่ 26 สิงหาคม 2566 \n\n ซึ่งงานปีนี้มาจะในธีม Discovery! มาร่วมค้นพบความเป็น MWIT พร้อมกันใน MWIT Open House 2023: Discover your future with us '
/*
  const subjAct = [
  {
        ...
        >
          <div className='w-full h-full py-6 flex items-center'>
            <div className='w-full max-w-7xl grid md:grid-cols-2 gap-6 items-center justify-items-center mx-auto px-6'>
              <div className='max-w-[640px] max-h-[480px] w-[16rem] md:w-[32rem] h-screen m-auto py-16 px-4 relative group'>
          ...
          >
            ...
            <div className='w-full max-w-7xl grid md:grid-cols-2 gap-6 items-center justify-items-center mx-auto px-6'>
              <div className='md:cols-span-1'>
                ...
                <div>
                  <div className='max-w-[640px] max-h-[480px] h-screen w-[16rem] md:w-[32rem] m-auto py-16 px-4 relative group'>
                    ...
                    {/* Right Arrow */}
                    <div className='hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[-50%] right-5 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer'>
                      <FontAwesomeIcon icon={faChevronRight} onClick={nextSlide1} size='sm' />
                    </div>
                    <div className='flex top-4 justify-center py-2'>
              ...
              <div className='md:cols-span-1'>
                ...
                <div>
                  <div className='max-w-[640px] max-h-[480px] h-screen w-[16rem] md:w-[32rem] m-auto py-16 px-4 relative group'>
                    ...
                    {/* Right Arrow */}
                    <div className='hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[-50%] right-5 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer'>
                      <FontAwesomeIcon icon={faChevronRight} onClick={nextSlide2} size='sm' />
                    </div>
                    <div className='flex top-4 justify-center py-2'>
