        ...
        >
          <div className='w-full h-full py-6 flex items-center'>
            <div className='w-full max-w-7xl grid md:grid-cols-2 gap-6 items-center justify-items-center mx-auto px-6'>
              <div className='max-w-[640px] max-h-[480px] min-w-max w-[40rem] h-screen m-auto py-16 px-4 relative group'>
                <div
          ...
          >
            ...
            <div className='w-full max-w-7xl grid md:grid-cols-2 gap-6 items-center justify-items-center mx-auto px-6'>
              <div className='md:cols-span-1'>
                ...
                <div>
                  <div className='max-w-[640px] max-h-[480px] h-screen min-w-max w-[40rem] m-auto py-16 px-4 relative group'>
                    <div
