...
const actdata = [
  ...
  },
  {
    ...
    desc : 'เพื่อวัดความสามารถด้านภาษาอังกฤษผ่านการแข่งขันชิงทุนการศึกษา และมีโอกาสได้สัมผัสบรรยากาศกิจกรรมที่เกิดขึ้นในโรงเรียน (การแข่งขัน Spelling Bee)',
    req : 'ลงทะเบียนล่วงหน้าเท่านั้น รับสมัคร 1-20 สิงหาคม  - ประเภทเดี่ยว ส่งได้โรงเรียนละไม่เกิน 3 คน ',
    date: 'แข่งวันที่ 25 สิงหาคม 2566 9.00-12.00  เวลาลงทะเบียน : 8.00-9.00 น.',
