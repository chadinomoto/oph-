...
export default function Competition() {
  ...
  return (
    ...
    req : 'ลงทะเบียนผ่านทางเว็บไซต์ได้ตั้งแต่วันที่ 1 - 18 สิงหาคม - ทีมละ 3 คน โรงเรียนละไม่เกิน 2 ทีม (รับไม่เกิน 150 ทีม) ',
    date: 'แข่งวันที่ 25 สิงหาคม 2566 ตั้งแต่เวลา 08.30 - 16.30 น.',
    other : 'สถานที่จัดการแข่งขัน หอประชุมพระอุบาลี (ชั้นสองของโรงอาหาร) โรงเรียนมหิดลวิทยานุสรณ์  อุปกรณ์ที่ผู้เข้าแข่งขันต้องเตรียม  บัตรนักเรียน/บัตรประชาชน เครื่องเขียน (ปากกา น้ำยาลบคำผิด ไม้บรรทัด)  รูปแบบการแข่ง : แข่ง 2 รอบ เพื่อหาผู้ชนะ  รอบที่ 1: รอบคัดเลือก คัดเลือก 10 ทีมที่ได้คะแนนสูงที่สุดเข้าร่วมการแข่งขันในรอบที่ 2 รอบที่ 2: รอบชิงชนะเลิศ แข่งขันทั้งหมด 2 ส่วน คือส่วนปฏิบัติการและส่วนทฤษฎี

          <div className='w-full h-full py-6 flex items-center grid grid-cols-1'>
                        ...
                        >
                          ...
                          <div className='flex flex-col gap-2 mt-2'>
                            ...
                            >
                              ...
                              <TextFormat
                              className='whitespace-pre-wrap'
                              content={'สถานที่จัดการแข่งขัน หอประชุมพระอุบาลี (ชั้นสองของโรงอาหาร) โรงเรียนมหิดลวิทยานุสรณ์  อุปกรณ์ที่ผู้เข้าแข่งขันต้องเตรียม  บัตรนักเรียน/บัตรประชาชน เครื่องเขียน (ปากกา น้ำยาลบคำผิด ไม้บรรทัด)  รูปแบบการแข่ง : แข่ง 2 รอบ เพื่อหาผู้ชนะ  รอบที่ 1: รอบคัดเลือก คัดเลือก 10 ทีมที่ได้คะแนนสูงที่สุดเข้าร่วมการแข่งขันในรอบที่ 2 รอบที่ 2: รอบชิงชนะเลิศ แข่งขันทั้งหมด 2 ส่วน คือส่วนปฏิบัติการและส่วนทฤษฎี'}
                              />
                            </span>
                          </div>
                          <button
